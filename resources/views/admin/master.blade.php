                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div>
                                            <img src="{{asset('/')}}admin/assets/images/megamenu-img.png" alt="" class="mx-auto img-fluid d-block">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item text-danger" href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('logout-form').submit()"><i class="mr-1 align-middle bx bx-power-off font-size-16 text-danger"></i>Logout</a>
                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('dashboard')}}" class="waves-effect">
                            <i class="bx bx-home-circle"></i><span class="float-right badge badge-pill badge-info">03</span>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="projects-list.html">Manage Order</a></li>
                        </ul>
                    </li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">$ 145 x 1</p>
                                        </div>
                                    </td>
                                    <td>$ 145</td>
                                </tr>
